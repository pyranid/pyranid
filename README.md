...
If you don't use Maven, you can drop [pyranid-1.0.18-SNAPSHOT.jar](https://repo.maven.apache.org/maven2/com/pyranid/pyranid/1.0.18-SNAPSHOT/pyranid-1.0.18-SNAPSHOT.jar) directly into your project.  No other dependencies are required.
