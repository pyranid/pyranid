...
If you don't use Maven, you can drop [pyranid-1.0.14.jar](http://central.maven.org/maven2/com/pyranid/pyranid/1.0.14/pyranid-1.0.14.jar) directly into your project.  No other dependencies are required.
