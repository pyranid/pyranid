...
If you don't use Maven, you can drop [pyranid-4.0.1-SNAPSHOT.jar](https://repo1.maven.org/maven2/com/pyranid/pyranid/4.0.1-SNAPSHOT/pyranid-4.0.1-SNAPSHOT.jar) directly into your project.  No other dependencies are required.
